<div class="footer">
    <div class="container-bordering"> <a class="footer--publisher" href="#">
        ...
        <div class="footer--navigation"> <a class="navigation-link" href="#"> </a>
            <a class="navigation-link" href="#" id="tg-logo">
            ...
            <a class="navigation-link" href="#" id="yt-logo">
            ...
            <a class="navigation-link" href="#" id="vk-logo">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <a class="navigation-link" href="#" id="linkedin-logo">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="footer--button"> <img
                src="<?=get_template_directory_uri() . '/assets/images/content/footerBtn.png'?>" alt=""></div>
    </div>
</div>
